export default function Modal() {
  return (
    <div className="fixed z-50 w-full h-full bg-backModal flex justify-center items-center">
        ...
        <div className="flex flex-col justify-center items-center p-8 ">
          ...
          <form action="" className="grid gap-5 mt-8">
            ...
            <div className="flex gap-3 justify-end">
              <button className="border-2 border-red-400 text-red-400 p-3 w-28 h-10 flex justify-center hover:bg-red-500 hover:text-white transition-all ease-in-out duration-300 items-center rounded-lg">
                Cancelar
              </button>
